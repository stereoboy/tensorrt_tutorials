...
public:
    ...
    // Ctor for clone()
    Cast(const int* flattenedInputSize, int numInputs, int flattenedOutputSize)
    ...
    Cast(const void* data, size_t length)
    {
    ...
    {
        // Returns Cast plugin serialization size
    ...
    {
        // Serializes Cast plugin into byte array
    ...
    {
        return new Cast(mFlattenedInputSize.data(), mFlattenedInputSize.size(), mFlattenedOutputSize);
    }
...
// PluginCreator boilerplate code for Cast plugin
...
public:
    ...
    IPluginV2* deserializePlugin(const char* name, const void* serialData, size_t serialLength) override
    {
        ...
        return new Cast(serialData, serialLength);
    }
...
PluginFieldCollection CastPluginCreator::mFC{};
std::vector<PluginField> CastPluginCreator::mPluginAttributes;
